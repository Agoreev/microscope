...
Meteor.methods
  ...
  upvote: (postId) ->
    ...
    affected = Posts.update { _id: postId, upvoters: {$ne: this.userId}}, {$addToSet: {upvoters: this.userId}, $inc: {votes: 1}}

    if !affected
      throw new Meteor.Error 'invalid', "You weren't able to update this post"
